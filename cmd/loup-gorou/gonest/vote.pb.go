...
//Message utilisé pour voté pour quelqu'un.
...
func (x *VoteMessage) GetTarget() string {
	if x != nil {
		return x.Target
	}
	return ""
...
var file_vote_proto_rawDesc = []byte{
	0x0a, 0x0a, 0x76, 0x6f, 0x74, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x06, 0x67, 0x6f,
	0x6e, 0x65, 0x73, 0x74, 0x22, 0x25, 0x0a, 0x0b, 0x56, 0x6f, 0x74, 0x65, 0x4d, 0x65, 0x73, 0x73,
...
var file_vote_proto_goTypes = []interface{}{
	(*VoteMessage)(nil), // 0: gonest.VoteMessage
}
